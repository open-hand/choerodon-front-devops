...
const deployment = {
  ...
  'c7ncd.deployment.instance.tabs.cases': '应用事件',
  ...
  'c7ncd.deployment.instance.status': 'Chart应用状态',
  ...
  'c7ncd.deployment.instance.action.delete': '删除应用',
  'c7ncd.deployment.instance.action.delete.tips': '删除应用后将不可恢复，同时与其相关的网络也将失效，确定要删除该应用吗？',
  ...
  'c7ncd.deployment.instance.cases.empty': '暂无应用事件',
  ...
  'c7ncd.deployment.instance.app.create': '部署应用',
  'c7ncd.deployment.instance.app.update': '更新应用',
  'c7ncd.deployment.instance.app.stop': '停止应用',
  'c7ncd.deployment.instance.app.restart': '启用应用',
  'c7ncd.deployment.instance.app.delete': '删除应用',
  ...
  'c7ncd.appService.Usernameandpassword': '用户名与密码',
  'c7ncd.appService.Usernameandpassword.content': '需至少输入该仓库内Maintainer角色的用户名和密码',
  'c7ncd.appService.PrivateToken': '私有Token',
  'c7ncd.appService.PrivateToken.content': '需至少使用Maintainer角色在GitLab中创建含有api权限的Access Token',
  ...
  'c7ncd.deployment.application.name': '应用名称',
  'c7ncd.deployment.application.code': '应用编码',
  'c7ncd.deployment.chart.version': 'Chart版本',
  'c7ncd.deployment.chart.resource': 'Chart包来源',
  ...
  'c7ncd.deployment.resource.instanceCount': 'Chart应用',
  ...
  'c7ncd.deployment.modal.redeploy.tips': '确定要重新部署该应用吗？此次部署版本为 “{versionName}”',
...
const deploy = {
  ...
  'c7ncd.deploy.instance.name': '应用名称',
  ...
  'c7ncd.deploy.status.canceled': '已停止',
  ...
  'c7ncd.deploy.instance.tips': '选择应用服务后，会默认生成应用名称，此名称可修改；此次部署默认为新建一个实例',
  ...
  'c7ncd.deploy.hzero.type.open': '开源应用',
  'c7ncd.deploy.hzero.type.sass': '商业应用',
...
const hostConfig = {
  ...
  'c7ncd.host.config.port.deploy': '内部SSH认证端口',
  'c7ncd.host.config.ip.distribute_test': 'IP',
  'c7ncd.host.config.ip.deploy': '内部SSH认证IP',
  ...
  'c7ncd.host.config.jmeter.path': 'JMETER_HOME路径',
  ...
  'c7ncd.host.config.account.private': '内部账号配置',
  'c7ncd.host.config.ip.external': '外部SSH认证IP',
  'c7ncd.host.config.port.external': '外部SSH认证端口',
  'c7ncd.host.config.account.external': '外部账号配置',
  ...
  'c7ncd.host.config.connect.AUTO': '自动连接',
  'c7ncd.host.config.connect.AUTO.des': '选择自动连接的方式后，需要您提供主机的SSH外部认证IP、SSH外部认证端口以及Root账号的信息；Choerodon将访问您的主机，在其中自动安装agent用于帮助管控主机资源。',
  'c7ncd.host.config.connect.MANUAL': '手动连接',
  'c7ncd.host.config.connect.MANUAL.des': '选择手动连接的方式后，Choerodon会提供一段指令，您需要在目标主机中手动执行该指令，而后会在其中自动安装agent用于帮助管控主机资源。',
  'c7ncd.host.config.attest': '内部认证',
  'c7ncd.host.config.attest.external': '外部认证',
  'c7ncd.host.config.attest.tips': '若想将此主机用于基础组件部署，则必须配置以下信息',
};

const emptyPage = {
  'empty.title.app': '暂无应用服务',
  'empty.title.env': '暂无环境',
  'empty.title.pipeline': '暂无应用流水线',
...
const appCenter = {
  ...
  'c7ncd.appCenter.tab.ENV_TAB': '容器应用',
  'c7ncd.appCenter.tab.HOST_TAB': '主机应用',
...
const pageDetail = {
  ...
  'ist.detail.title': '查看应用"{name}"的详情',
...
const cluster = {
  ...
  'c7ncd.cluster.node.action.removeRole.master': '移除master角色',
  'c7ncd.cluster.node.action.removeRole.etcd': '移除etcd角色',
  'c7ncd.cluster.node.modal.removeRole': '移除',
  'c7ncd.cluster.node.modal.canDelete': '删除节点',
  ...
  'c7ncd.import.gitlab.activate.note': '注意：迁移操作执行成功后，代码仓库将从原来的Group中迁移至当前项目对应的Group，且操作不可撤销。',
...
const zhCN = {
  ...
  'ist.deploy.detail': '查看应用Deployment详情',
  'ist.deploy.Deployment.detail': '查看应用Deployment详情',
  'ist.deploy.StatefulSet.detail': '查看应用Stateful Set详情',
  'ist.deploy.DaemonSet.detail': '查看应用Daemon Set详情',
  'ist.deploy.Job.detail': '查看应用Job详情',
  'ist.deploy.CronJob.detail': '查看应用CronJob详情',
  'ist.deploy.title': '查看应用“{name}”的Deployment详情',
  'ist.deploy.type.json': '列表格式查看',
  'ist.deploy.type.yaml': 'YAML格式查看',
  'ist.deploy.description': '您可在此查看各个应用Deployment的详情。',
  ...
  'network.application.check.failed': '请移除不可用的应用',
  'network.instance.check.failed.more': '请选择目标对象为所有应用或单个应用',
  'network.deploy.check.failed.more': '请选择目标对象为单个应用',
  ...
  'network.target.application': '选择应用',
  'network.target.param': '填写标签',
  'network.isChart.chart': 'Chart应用',
  'network.isChart.deployment': '部署组应用',
  ...
  'deploy.ist.event': '应用事件',
  'deploy.ist.event.empty': '暂无应用事件',
  ...
  'branch.issue.source': '关联问题来源项目',
  'branch.issue.source.name': '问题来源项目',
  'branch.source': '分支来源',
  'branch.owner': '提交者',
  'branch.time': '创建者',
  'branch.edit': '修改关联问题',
