  ...
  render() {
    ...
    const task = _.map(tasks,
      ({
        ...
        const panelHead = (
          <div className="c7ncd-pipeline-panel-title">
            <Tooltip
              title={name}
              placement="top"
            >
        ...
        const expandRow = {
          ...
          auto: () => (
            <>
              <div className="c7ncd-pipeline-task">
                <span className="c7ncd-pipeline-task-label">
        ...
        return (
          <Panel key={id} className="c7ncd-pipeline-panel" header={panelHead}>
    ...
    return (
      <div className="c7ncd-pipeline-card">
        <div className="c7ncd-task-top">
          {formatMessage({ id: 'pipeline.task.settings' })}
          {' '}
          -
          {' '}
          <FormattedMessage
