...
export default class HostConfigApi {
  ...
  static getLoadHostsDetailsUrl(projectId:number) {
    return `/devops/v1/projects/${projectId}/hosts/page_by_options?with_creator_info=true`;
  }
  ...
  static updateHostPermission(projectId: number, hostId: string) {
    return `/devops/v1/projects/${projectId}/hosts/${hostId}/batch_update_permission`;
  }
