...
// 市场服务 |HZERO服务 === market
// 主机 === host
// 详情页url: /detail/应用服务id/制品来源（ normal|  market | host ）/ 部署类型deployType(env或host) / 启用 | 停用 | 处理中 | 失败 | 成功
  ...
  return (
    <StoreProvider {...props}>
      <Switch>
        ...
        <Route exact path={`${match.url}/detail/:appId/:appSource/:deployType/:deployTypeId/:status`} component={AppDetail} />
