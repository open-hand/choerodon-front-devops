import React, {
  Component, Fragment, useState, useEffect, useMemo,
} from 'react';
...
export default observer(() => {
   ...
   * @param {*} name
   */
  const handleClick = async (type, id, name) => {
    setIsDisabled(true);
        ...
        <div key={name} className="c7ncd-instance-details-grid">
          <div>
            ...
            <Button
              ...
              type="primary"
              onClick={isDisabled ? null : () => handleClick(podType, instanceId, name)}
            >
