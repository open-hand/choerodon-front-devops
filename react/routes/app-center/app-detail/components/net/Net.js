    ...
    const buttons = [
      {
        ...
        action: () => {
          openDeleteModal(parentId, netId, name, 'service', refresh);
        },
      },
    ];
        ...
        const buttons = [
          {
            ...
            text: formatMessage({ id: 'delete' }),
            action: () => {
              openDeleteModal(parentId, itemId, name, 'ingress', refresh);
            },
          },
        ];
        const disabled = getEnvIsNotRunning() || status === 'operating';
    ...
    <div className={`${prefixCls}-application-net`}>
      <div className="c7ncd-tab-table">
        ...
        >
          ...
          <Column renderer={renderTargetType} header={formatMessage({ id: 'c7ncd.deployment.application.net.targetType' })} />
          <Column renderer={renderTarget} header={formatMessage({ id: 'c7ncd.deployment.application.net.target' })} />
