export default class CodeManagerApis {
  ...
  static loadSummaryData(projectId: string, issueId?: string) {
    return `/agile/v1/projects/${projectId}/issues/summary?onlyActiveSprint=false&self=true${issueId ? `&issueId=${issueId}` : ''}`;
  }
}
