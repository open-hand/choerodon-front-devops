...
export default function useStore() {
  return useLocalStore(() => ({
    ...
    queryBranchData({
      projectId, sorter = { field: 'createDate', order: 'asc' }, postData = { searchParam: {}, param: '' }, size = 3, appServiceId,
    }) {
    ...
    checkCreate(projectId, appServiceId, type = 'TAG_CREATE') {
      return axios.get(`/devops/v1/projects/${projectId}/member-check/${appServiceId}?type=${type}`);
    },
  }));
}
